...
const EVIDENCE_POSTURES = {
  ...
  modeled: { label: "Modeled", color: T.amber, bg: T.amberDim, desc: "Parameterized model — not benchmarked, not proven" },
      ...
      <div style={{
        ...
        <section id="about-labs">
          ...
          <div style={{
            ...
            evidence posture — simulated, abstracted, derived, modeled, or architecture-level — so you always know what kind of truth is being presented.
          </div>
